...
shinyUI(fluidPage(
  ...
  sidebarLayout(
    sidebarPanel(
      ...
      sliderInput("n_iters","No. of iterations:", min=10, max=200, value = 10, step = 10),
      sliderInput("n_samples","No. of samples per iteration:", min=50, max=2000, value = 50, step = 50)
    ),
